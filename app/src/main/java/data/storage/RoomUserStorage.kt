...
class RoomUserStorage(context: Context) : UserStorage {
    ...
    override suspend fun getMuscleMenu(): List<MuscleTypeItem> {
        Log.d(
            "FixRoad",
            "RoomUserStorage Muscle Create ${muscleTypeDb.getDao().getAllMuscleItems()}"
        )
    ...
    override suspend fun getExerciseMenu(muscleName: String): List<ExerciseTypeItem> {
        Log.d(
            "FixRoad",
            "RoomUserStorage Exercise Create ${
                exerciseTypeDb.getDao().getAllExerciseByMuscle(muscleName)
            }"
        )
    ...
    override fun saveExerciseStats(exerciseStatItem: ExerciseStatItem) {
        Log.d(
            "FixRoad",
            "RoomUserStorage Exercise Stats Save ${
    ...
    override fun getExerciseStats(exerciseName: String): List<ExerciseStatItem> {
        Log.d(
            "FixRoad",
            "RoomUserStorage Exercise Stats Get ${
                exerciseStatsDb.getDao().getExerciseStatsByExerciseName(exerciseName)
            }"
        )
